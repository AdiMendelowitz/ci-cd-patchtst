...
[OpenReview](https://openreview.net/forum?id=aiUZ2y8UNl).
...
ci-cd-patchtst/
  ...
  CITATION.cff
  LICENSE
  mendelowitz2026equalaccuracy.pdf    the published paper (camera-ready PDF)
...
[`LICENSE`](LICENSE). The paper itself is published by TMLR under CC BY 4.0.
